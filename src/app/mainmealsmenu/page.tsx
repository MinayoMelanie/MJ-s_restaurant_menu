...
export default function DrinksMenu() {
    const mainmealCategories = [
        { title: "Starters", image: "/starters.jpg" },
        { title: "Red meat", image: "/redmeat.jpg" },
        { title: "White meat", image: "/whitemeat.jpg" },
        { title: "Pasta", image: "/pasta.jpg" },
        { title: "Pizza", image: "/pizza.jpg" },
        { title: "Burger", image: "/burger.jpg" },
        { title: "Soup", image: "/soup.jpg" },
        { title: "Platter", image: "/platter.jpg" },
    ];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-20 overflow-hidden">
                <div className="relative h-[30vh] sm:h-[40vh] md:h-[50vh] lg:h-[60vh] xl:h-[70vh]">
                    ...
                    >
                        ...
                        Indulge in Every Bite – From Savory Starters to Delectable Desserts, Our Main Meals Are Crafted to Delight and Satisfy Every Craving!
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-4 py-16 md:py-24">
                ...
                >
                    <h2 className="text-2xl md:text-3xl font-serif text-[#DC2626] mb-4">MAIN MEALS MENU</h2>
                    <div className="h-0.5 w-20 bg-[#DC2626] mx-auto" />
                </motion.div>

                {/* Grid Layout for Mainmeal Categories */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {mainmealCategories.map((category, index) => (
                        <motion.div
                            key={category.title}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.6, delay: index * 0.1 }}
                            className="group relative rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300"
                        >
